...
class ForwardBatch:
    ...
    state_camera_extrinsic_path: str | None = None
    ...
    camera_xi: float | None = None  # Mei mirror parameter (> 0 triggers fisheye path)
    camera_dist: list[float] | None = None  # Mei distortion coefficients [k1, k2, k3, p1, p2]
    ...
    camera_control_origin: tuple | None = None  # Origin camera parameters
    control_camera_latents_input: torch.Tensor | None = None  # Processed camera control latents
    ...
    spatial_preprocess: str = "direct_resize"

    # Hand control parameters
    control_hand_state_path: str | None = None
