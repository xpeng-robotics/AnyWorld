...
_PIPELINE_NAME_TO_ARCHITECTURE_NAME: dict[str, str] = {
    ...
    "WanImageToVideoControlPipeline": "wan",
    "WanImageToVideoCameraControlPipeline": "wan",
    "WanImageToVideoCombinedControlPipeline": "wan",
    "WanImageToVideoHandControlPipeline": "wan",
...
class _PipelineRegistry:
    ...
    def _try_load_pipeline_cls(
        ...
        if pipeline_type is not PipelineType.BASIC:
            raise ValueError(f"Invalid inference pipeline type: {pipeline_type.value}")
...
def import_pipeline_classes(
    ...
    Args:
        pipeline_types: The inference pipeline types to load. 
