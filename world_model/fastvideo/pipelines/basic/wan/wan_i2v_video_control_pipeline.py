...
class WanImageToVideoControlPipeline(LoRAPipeline, ComposedPipelineBase):
    ...
    def create_pipeline_stages(self, fastvideo_args: FastVideoArgs):
        ...
        if self.get_module("transformer").ref_conv is not None:
            self.add_stage(stage_name="video_control_stage",
                            stage=VideoControlStage(vae=self.get_module("vae")))
...
EntryClass = WanImageToVideoControlPipeline
