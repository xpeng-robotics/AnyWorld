...
from fastvideo.configs.pipelines.wan import (
    ...
    WanI2V480PCameraControlConfig,
    WanI2V480PControlConfig,
    WanI2V480PHandControlConfig,
    WanI2V480PCombinedControlConfig,
    WanI2V480PConfig,
    WanI2V720PConfig,
    WanT2V480PConfig,
    WanT2V720PConfig,
...
PIPE_NAME_TO_CONFIG: dict[str, type[PipelineConfig]] = {
    ...
    "Wan2.1-Fun-V1.1-14B-Control-Camera-Diffusers": WanI2V480PCameraControlConfig,
    "Wan2.1-Fun-V1.1-14B-Control-Diffusers": WanI2V480PControlConfig,
    "Wan2.1-I2V-14B-480P-Hand-Control-Diffusers": WanI2V480PHandControlConfig,
    "Wan2.1-I2V-1.3B-480P-Hand-Control-Diffusers": WanI2V480PHandControlConfig,
    "Wan2.1-I2V-14B-480P-Combined-Control-Diffusers": WanI2V480PCombinedControlConfig,
...
PIPELINE_DETECTOR: dict[str, Callable[[str], bool]] = {
    ...
    "wanimagetovideocameracontrol": lambda id: "wanimagetovideocameracontrol" in id.lower(),
    "wanimagetovideocontrol": lambda id: "wanimagetovideocontrol" in id.lower(),
    "wanimagetovideohandcontrolpipeline": lambda id: "wanimagetovideohandcontrolpipeline" in id.lower(),
    "wanimagetovideocombinedcontrolpipeline": lambda id: "wanimagetovideocombinedcontrolpipeline" in id.lower(),
...
PIPELINE_FALLBACK_CONFIG: dict[str, type[PipelineConfig]] = {
    ...
    "wanimagetovideocameracontrolpipeline": WanI2V480PCameraControlConfig,
    "wanimagetovideocontrolpipeline": WanI2V480PControlConfig,
    "wanimagetovideohandcontrolpipeline": WanI2V480PHandControlConfig,
    "wanimagetovideocombinedcontrolpipeline": WanI2V480PCombinedControlConfig,
